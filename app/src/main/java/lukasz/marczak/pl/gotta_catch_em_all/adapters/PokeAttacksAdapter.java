 ...
 */
public abstract class PokeAttacksAdapter extends RecyclerView.Adapter<PokeAttacksAdapter.ViewHolder> implements Progressable {
    public static final String TAG = PokeAttacksAdapter.class.getSimpleName();
    public static List<PokeMove> dataset = new ArrayList<>();
    private Progressable context = null;
